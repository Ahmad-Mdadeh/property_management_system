...
class HouseFiled extends StatelessWidget {
  HouseFiled({required this.buildContext, Key? key}) : super(key: key);
          ...
          children: [
            ...
            Padding(
              ...
              child: ProfileTextFromFiled(
                ...
                function: (value) {
                  _createPostController.priceOrMonthlyRent = value;
                },
                validator: (value) {
            ...
            Padding(
              ...
              child: ProfileTextFromFiled(
                ...
                function: (value) {
                  _createPostController.about = value;
                },
                validator: (value) {
            ...
            Padding(
              ...
              child: ProfileTextFromFiled(
                ...
                textInputType: TextInputType.text,
                function: (value) {
                  _createPostController.address = value;
                },
                validator: (value) {
                  if (!RegExp(validationName).hasMatch(value)) {
                    return "invalid name";
            ...
            Padding(
              ...
              child: ProfileTextFromFiled(
                ...
                textInputType: TextInputType.number,
                function: (value) {
                  _createPostController.area =value;
                },
                validator: (value) {
                  if (!RegExp(validationNumber).hasMatch(value)) {
                    return "invalid name";
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ProfileTextFromFiled(
                        ...
                        textInputType: TextInputType.number,
                        function: (value) {
                          _createPostController.bathRoomCount =
                          value;
                        },
                        validator: (value) {
                          if (!RegExp(validationNumber).hasMatch(value)) {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ProfileTextFromFiled(
                        ...
                        textInputType: TextInputType.number,
                        function: (value) {
                          _createPostController.latitude =value;
                        },
                        validator: (value) {
                          if (!RegExp(validationNumber).hasMatch(value)) {
                            return "invalid Number";
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        _createPostController.chengCheckBoxGym();
                      },
                      icon: Icon(
                        _createPostController.isCheckBoxGym.value
                            ? Icons.check_box
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      highlightColor: Colors.transparent,
                      onPressed: () {
                        _createPostController.chengCheckBoxPool();
                      },
                      icon: Icon(
                        _createPostController.isCheckBoxPool.value
                            ? Icons.check_box
                            : Icons.check_box_outline_blank,
                        color: Theme.of(buildContext).iconTheme.color,
                      ),
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      highlightColor: Colors.transparent,
                      onPressed: () {
                        _createPostController.chengCheckBoxGarden();
                      },
                      icon: Icon(
                        _createPostController.isCheckBoxGarden.value
                            ? Icons.check_box
                            : Icons.check_box_outline_blank,
                        color: Theme.of(buildContext).iconTheme.color,
                      ),
